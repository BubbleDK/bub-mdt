    ...
    return (
        <div className={className}>
            ...
            >
                ...
                <ChevronDown
                    className={`ml-2 h-3.5 w-3.5 shrink-0 text-neutral-500 transition-transform duration-200 group-hover:text-neutral-300 ${isOpen ? "rotate-180" : ""}`}
                />
            </button>
                                    ...
                                    return (
                                        ...
                                        >
                                            <span className="min-w-0 flex-1">
                                                <span
                                                    className={`block truncate text-xs font-medium ${selected ? "text-blue-200" : "text-neutral-200"}`}
                                                >
                                                    {option.label}
                                                </span>
                                                {option.description && (
                                            ...
                                            <span
                                                className={`flex h-5 w-5 shrink-0 items-center justify-center rounded-md ${selected ? "bg-blue-500 text-white" : "text-transparent"}`}
                                            >
