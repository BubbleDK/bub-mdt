				...
				<div className='charges-create'>
					...
					<div className='charges-create-content'>
						...
						<Select
							...
							data={[
								{
									value: "OFFENSES AGAINST PERSONS",
									label: "OFFENSES AGAINST PERSONS",
								},
								{
									value: "OFFENSES INVOLVING THEFT",
									label: "OFFENSES INVOLVING THEFT",
								},
								{
									value: "OFFENSES INVOLVING FRAUD",
									label: "OFFENSES INVOLVING FRAUD",
								},
								{
									value: "OFFENSES INVOLVING DAMAGE TO PROPERTY",
									label: "OFFENSES INVOLVING DAMAGE TO PROPERTY",
								},
								{
									value: "OFFENSES AGAINST PUBLIC ADMINISTRATION",
									label: "OFFENSES AGAINST PUBLIC ADMINISTRATION",
								},
								{
									value: "OFFENSES AGAINST PUBLIC ORDER",
									label: "OFFENSES AGAINST PUBLIC ORDER",
								},
								{
									value: "OFFENSES AGAINST HEALTH AND MORALS",
									label: "OFFENSES AGAINST HEALTH AND MORALS",
								},
								{
								...
								{
									value: "OFFENSES INVOLVING THE OPERATION OF A VEHICLE",
									label: "OFFENSES INVOLVING THE OPERATION OF A VEHICLE",
								},
								{
									value: "OFFENSES INVOLVING THE WELL-BEING OF WILDLIFE",
									label: "OFFENSES INVOLVING THE WELL-BEING OF WILDLIFE",
								},
							]}
