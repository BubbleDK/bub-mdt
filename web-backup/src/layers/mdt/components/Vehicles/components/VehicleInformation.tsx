				...
				<div className='vehicle-card-content'>
					...
					<div className='vehicle-card-information'>
						...
						>
							...
							<Indicator
								label={
									<Text style={{ fontSize: 14, color: "white" }} weight={500}>
										{locales.bolo}
									</Text>
								}
								size={24}
								radius='sm'
								color='red'
								disabled={!isVehicleBOLO}
							>
								<Image
									src={
										selectedVehicle.image
											? selectedVehicle.image
											: `https://gtahash.ru/cars/${selectedVehicle.class.toLowerCase()}/${selectedVehicle.model.toLowerCase()}.jpg`
									}
									radius={"lg"}
									height={225}
									width={500}
									withPlaceholder
									placeholder={
										<Text align='center'>Image of vehicle was not found</Text>
									}
								/>
							</Indicator>
						</div>
						...
						<div className='vehicle-card-information-inputs'>
							...
							<Input
								...
								placeholder={
									selectedVehicle.class === "Sport-Classic"
										? capitalizeFirstLetter("Sports Classic")
										: capitalizeFirstLetter(selectedVehicle.class)
								}
								size='sm'
							/>
					...
					>
						{isVehicleBOLO && (
							<Text style={{ fontSize: 14, color: "red" }} weight={500}>
								{locales.bolo_expires_at} {BOLOExpirationDate}
							</Text>
						)}
							...
							onClick={() =>
								!isVehicleBOLO
									? modals.open({
											...
											size: "lg",
											children: (
												<CreateBoloModal plate={selectedVehicle.plate} />
											),
									  })
									: modals.openConfirmModal({
											...
											children: (
												<Text size='sm' c='dark.2'>
													{locales.delete_bolo_confirm.format(
							...
							onCreate={(query) => {
								fetchNui(
									"saveVehicleInformation",
									{
										plate: selectedVehicle.plate,
										knownInformation: [
											...selectedVehicle.knownInformation,
											query,
										],
									},
									{ data: 1 }
