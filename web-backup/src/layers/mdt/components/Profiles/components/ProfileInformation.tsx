...
const ProfileInformation = () => {
	const { selectedProfile, setSelectedProfile, isProfileWanted } =
		useProfilesStore();
						...
						<div className='profile-card-wrapper'>
							...
							>
								...
								<Image
									...
									src={
										...
										"https://r2.fivemanage.com/s64hZD0G9WtYHbURWCuSc/placeholder.jpg"
									}
									radius={"md"}
								...
								{isProfileWanted && (
									<Image
										className='watermark'
										src={
											"https://r2.fivemanage.com/s64hZD0G9WtYHbURWCuSc/wanted-stamp.png"
										}
										radius={"md"}
										alt='With default placeholder'
										withPlaceholder
							...
							<div className='profile-card-inputs'>
								...
								<Input
									...
									placeholder={
										selectedProfile.fingerprint ?? "No fingerprint found"
									}
									size='xs'
								/>
							</div>
