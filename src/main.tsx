...
debugData([{
  ...
  data: {
    ...
    officers: [
      { citizenid: "CITI12345", firstname: 'Bubble', lastname: 'Test', role: 'Chief', callsign: 'C-01', phone: '0000000', image: 'https://www.gamersheroes.com/wp-content/uploads/2021/12/How-To-Fix-Invisibility-Bug-In-Agencies-In-GTA-Online.jpg', },
    ...
    incidents: [
      {
        ...
        title: 'Incident 1',
        details: 'Whatever',
        tags: [{ value: "dangerous", label: "Dangerous", backgroundcolor: "red" }, {value: 'funny', label: 'Funny guy', backgroundcolor: "green"}],
      ...
      },
      {
        ...
        tags: [{ value: "dangerous", label: "Dangerous", backgroundcolor: "red" }],
